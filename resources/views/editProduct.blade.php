...
<body>
    <section>
        <div class="prod">
            ...
            <form id="product" action="{{route('updateProd', $products->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('patch')
                <div class="mb-3">
                ...
                <div class="inputname">
                    <div class="input_box">
                        <input type="text" placeholder="Product Name" name="prodName" id="prodName" value="{{$products->prodName}}" required>
                        <i class="fa fa-users" style="color: whitesmoke;"></i>
                    </div>
                </div>
                <div class="inputPrice">
                    <div class="input_box">
                        <input type="text" placeholder="Rp. 1.000.000" name="Price" id="Price"  value="{{$products->Price}}" required>
                        <i class="fa fa-user icon" style="color: whitesmoke;"></i>
                    </div>
                </div>
                <div class="inputNum">
                    <div class="input_box">
                        <input type="number" placeholder="Total Stock" name="Total" id="Total" value="{{$products->Total}}" required>
