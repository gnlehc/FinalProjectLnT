    ...
    <section class="payment">
        ...
        <div class="pay">
            ...
            <form action="/create" method="POST">
                ...
                <div class="inputname">
                    <div class="input_box">
                        <input type="text" placeholder="Name" name="Name" value="{{Session::get('Name')}}" id="Name" minlength=5 maxlength=20 required>
                        <i class="fa fa-user icon" style="color: whitesmoke;"></i>
                    </div>
                </div>
                <div class="inputemail">
                    <div class="input_box">
                        <input type="email" placeholder="Email" name="Email" value="{{Session::get('Email')}}" id="Email" min=20 required>
                        <i class="fa fa-envelope-o" style="color: whitesmoke;"></i>
                    </div>
            </div>
            <div class="inputAdd">
                <div class="input_box">
                    <input type="password" placeholder="Password" name="password" id="password" minlength=6 maxlength=12 required>
            ...
            <div class="inputTLP">
                <div class="input_box">
                    <input type="tel" placeholder="Telephone Number" name="TLP" id="TLP" required>
